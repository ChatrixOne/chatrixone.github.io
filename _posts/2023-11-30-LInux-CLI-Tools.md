---
title: Линукс терминал - инструменти
...
**wttr.in** е услуга, която показва времето във формат, който може да се визуализира на командния ред. Просто стартирайте `curl wttr.in` или `curl wttr.in/Sofia`, за да го изпробвате. Има **URL** параметри, за да персонализирате показваните данни, както и формата.
