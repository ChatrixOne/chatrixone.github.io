...
Недостатък от използването на XMPP e, че повечето приложения са лишени от онзи пристрастяващ блясък и модернизъм в потребителския интерфейс, каращ потребителя да не отлепвате очи от екрана. Липсва и онзи циничен клюкарският елемент, който е типичен за водещите социални мрежи.

При XMPP комуникацията, нещата са по-скоро с практическа насоченост. Прекарвате далеч по-малко време взирайки се в екрана на вашето устройство. Именно поради тази причина, можете да се съсредоточите към далеч по-стойностните за вас неща от живота.
