...
JMeter представлява софтуер с отворен код, написан на Java. Определя дали уеб приложения могат да задоволят изискванията за високо натоварване. За да тествате вашия XMPP сървър е необходимо да инсталирате плъгин.
