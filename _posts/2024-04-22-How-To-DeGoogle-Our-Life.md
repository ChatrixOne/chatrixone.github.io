...
> **Предупреждение!**
>
> Дори и най-сигурната операционна система, може да бъде компрометирана, ако инсталираме неподходящи приложения. Ако желаем да сме сигурни в избора, е добре да се доверим на приложения, които са се доказали във времето, разработват се активно и не изискват достъп до ненужни разрешения.
> Това, че дадено приложение е с отворен код, в никакъв случай не означава - 100% сигурно или проверено.
{: .prompt-warning }
...
> Приложенията наличнии в **F-Droid** и **Aurora Store**, са минали през проверка.
{: .prompt-tip }
