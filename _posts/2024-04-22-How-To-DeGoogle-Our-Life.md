...
![Google Play Store App Permissions](play-store-permissions.png){: width="300" height="500" }
_Права изисквани от приложението Play Store, които при стандартна версия на Android не могат да бъдат ограничени._
...
> Следващите операционни системи трудно бих препоръчал. Включени са в статията, тъй като също са алтернатива. Освен това, ще бъде интересно да проследим как ще продължат да се развиват в бъдеще.
{: .prompt-info }
